...
public class SignUp {
            ...
            if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                if (name && email && phone && pass && rePass) {
                    ...
                    try {
                        ...
                        // Get the file from folder (Source link)
                        File userInfoFile = new File("src/UserInfoFile.txt");

                        // If the file not exist, create new file
                        if (!userInfoFile.exists()) {
                            userInfoFile.createNewFile();  // Create the file
                        }
                        ...
                        // Variable prepare to save each line in the file
                        String[] line = new String[1000];

                        // Read the file and each line into the variable until reach null line
                        while ((line[x] = reader.readLine()) != null) {
                            x++;
                        }

                        // Calculate how many account in the file
                        x = x / 6;

                        for (int i = 0 ; x > 0; x--, i+=6) {

                            // If username dah ada in file, error
                            ...
                            // If email dah ada in file, error
                            ...
                            // If phone dah ada in file, error
                            ...
                            // If tiga3 tak ada, go through
                            if (!name || !email || !phone) return;

                        }

                        // Output File (Write the signup details into file
                        ...
                        // If file not found will prompt this
                        // But this normally will not prompt cuz if file takde, cuz will auto create a file
    ...
    // Same as atas, but one is for 'enter' key
    // One is for button
    ...
    // If the dah ada account, click the login text (Blue sentence)
    // MouseClick listener
