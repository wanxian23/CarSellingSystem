...
public class TransactionPage {
    ...
    public void createTransactionPage(String emailUser, String carCategoryChoose, String carModelChoose,
        ...
        transMethod.setFont(new Font("Century Gothic", Font.BOLD, 45));
        ...
        chequeRB.setFont(new Font("Century Gothic", Font.BOLD, 30));
        chequeRB.setBackground(Color.WHITE);

        JRadioButton cardRB = new JRadioButton("CARD");
        cardRB.setFont(new Font("Century Gothic", Font.BOLD,30));
        ...
        deliveryDetailsTtile.setTitleFont(new Font("Arial", Font.BOLD, 27));
        deliveryDetailsPanel.setBorder(deliveryDetailsTtile);
        deliveryDetailsPanel.setFont(new Font("Arial", Font.BOLD, 25));
        ...
        Dimension labelDimension = new Dimension(400, 30);
        ...
        for (int i = 0; i < deliveryLabels.length; i++) {
            ...
            if (i == 4) {
                ...
                stateComboBox.setFont(new Font("Century Gothic", Font.PLAIN, 20));
                gbc.gridx = 1;
                deliveryDetailsPanel.add(stateComboBox, gbc);

                textField1[4] = new JTextField();
                textField1[4].setPreferredSize(textFieldDimension);
                textField1[4].setFont(new Font("Century Gothic", Font.PLAIN, 20));
                gbc.gridx = 1;
                gbc.gridy = 1 + i;
                ...
                textField1[i].setFont(new Font("Century Gothic", Font.PLAIN, 20));
                gbc.gridx = 1;
        ...
        carDetailsTtile.setTitleFont(new Font("Arial", Font.BOLD, 27));
        ...
        for (int i = 0; i < cardLabels.length; i++) {
            ...
            if (cardLabels[i].equals("Expiry Date (MM/YY):")) {
                ...
                monthTField.setFont(new Font("Century Gothic", Font.PLAIN, 20));
                ...
                yearTField.setFont(new Font("Century Gothic", Font.PLAIN, 20));
                ...
                textField2[i].setFont(new Font("Century Gothic", Font.PLAIN, 20));
                gbc.gridx = 1;
                gbc.gridy = 1 + i;
        ...
        textField2[3].setFont(new Font("Century Gothic", Font.PLAIN, 20));
        gbc.gridx = 1;
        gbc.gridy = 4;
        cardDetailsPanel.add(textField2[3], gbc);

        JLabel cardTypeLabel = new JLabel("Card Type:");
        cardTypeLabel.setFont(new Font("Century Gothic", Font.PLAIN, 25));
        ...
        visaRB.setFont(new Font("Century Gothic", Font.PLAIN, 25));
        visaRB.setBackground(Color.WHITE);
        JRadioButton masterCardRB = new JRadioButton("MasterCard");
        masterCardRB.setFont(new Font("Century Gothic", Font.PLAIN, 25));
        ...
        saveCardCB.setFont(new Font("Century Gothic", Font.PLAIN, 23));
        gbc.gridx = 0;
        gbc.gridy = 6;
        gbc.gridwidth = 2;
        ...
        termsCB.setFont(new Font("Century Gothic", Font.PLAIN, 23));
        gbc.gridy = 7;
        ...
        backTButton.setFont(new Font("Century Gothic", Font.BOLD, 20));
        backTButton.setForeground(Color.WHITE);
        backTButton.setBackground(Color.BLACK);
        backTButton.setPreferredSize(new Dimension(150, 50));
